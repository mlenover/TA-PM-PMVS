...
N = -3 # number of input views selected by the min-sum in Eq.8, i.e. value of \mathcal{M}, if negative, number of views discarded by min-sum #default -3


exp_name = 'anisotropy-test' # name of the experiment, used when saving intermediate results
input_file = 'data/input-file.npy' # path to input file that contains imgs and camera parameters
min_dist = 10  # min depth (distance of object from reference view point) in world unit
max_dist = 200 # max depth (distance of object from reference view point) in world unit # default 200
...
no_patchmatch_iterations=10 # how many iterations per PatchMatch #default 10
...
blender_directory = '/home/mlenover/Applications/blender-3.1.0-linux-x64'
